...
"carreira/comunicacao-homeoffice.md": {
	id: "carreira/comunicacao-homeoffice.md";
  slug: "carreira/comunicacao-homeoffice";
  body: string;
  collection: "post";
  data: InferEntrySchema<"post">
} & { render(): Render[".md"] };
"carreira/iniciar-programar.md": {
	id: "carreira/iniciar-programar.md";
  slug: "carreira/iniciar-programar";
  body: string;
  collection: "post";
  data: InferEntrySchema<"post">
} & { render(): Render[".md"] };
"carreira/mercado-python.md": {
	id: "carreira/mercado-python.md";
  slug: "carreira/mercado-python";
  body: string;
  collection: "post";
  data: InferEntrySchema<"post">
} & { render(): Render[".md"] };
